  ...
  return (
    <article tabIndex={0} onTouchStart={(e) => (e.currentTarget as HTMLElement).focus()} className={`group relative w-full max-w-[320px] h-100 rounded-md overflow-hidden duration-300`}>
      ...
      <div
        ...
        className="z-3 absolute w-[70%] h-auto text-white text-sm bg-st bottom-12 flex  flex-col gap-1 justify-center pl-3 py-1 duration-500 -left-[100%] opacity-0 group-hover:-left-[0%] group-hover:opacity-100 group-focus-within:-left-[0%] group-focus-within:opacity-100"
      >
        <p className="text-sm opacity-0 -translate-x-10 delay-500 duration-300 group-hover:opacity-100 group-hover:-translate-x-0 group-focus-within:opacity-100 group-focus-within:-translate-x-0">{profession}</p>
        <div className="flex opacity-0 -translate-x-10 delay-500 duration-300 group-hover:opacity-100 group-hover:-translate-x-0 group-focus-within:opacity-100 group-focus-within:-translate-x-0">
          <div className="">
      ...
      <div
        ...
        className="z-1 absolute w-[calc(70%+4px)] h-auto text-sm bg-white/90 bottom-12 flex flex-col gap-1 justify-center pl-3 py-1 duration-500 -left-[100%] opacity-0 group-hover:-left-[0%] group-hover:opacity-100 group-focus-within:-left-[0%] group-focus-within:opacity-100"
      >
        {/* Para que se adapte */}
