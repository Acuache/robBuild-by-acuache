...
export default function CardLeftImageDescription({ imageName, titleImage, descriptionImage }: CardLeftImageDescriptionProps) {
  ...
  return (
    <article ref={ref} className='w-full flex flex-col items-center lg:flex-row lg:relative  lg:px-8 xl:px-0 lg:-mt-25'>
      ...
      <div className={`flex flex-col justify-center items-center p-7 gap-4 bg-white lg:absolute  lg:right-0 lg:top-1/2 lg:-translate-y-1/4 sm:p-12 sm:max-w-115 sm:-mt-20 lg:flex-1/3 text-start  lg:items-start transition-all duration-1000 ${inView ? "opacity-100 translate-x-0" : "opacity-0 translate-x-80"}`}>
